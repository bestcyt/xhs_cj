 ...
 * @return {Object}      New object. Obj1 and Obj2 will be un.
 * @private
 */
...
vjs.Component.prototype.emitTapEvents = function(){
  ...
  this.on('', function() {
    ...
    if (couldBeTap === true) {
      ...
      if (touchTime < 250) {
        this.trigger('tap');
        // It may be good to copy the  event object and change the
...
vjs.Slider.prototype.onMouseDown = function(event){
  ...
  vjs.on(document, '', this.boundEvents.end);
...
vjs.Slider.prototype.onMouseUp = function() {
  ...
  vjs.off(document, '', this.boundEvents.end, false);
...
vjs.MediaTechController.prototype.addControlsListeners = function(){
  ...
  // consistency. We don't want to bubble a  without a touchstart.
  this.on('touchstart', function(event) {
  ...
  this.on('', preventBubble);

  // Turn on component tap events
  this.emitTapEvents();

  // The tap listener needs to come after the  listener because the tap
