...
SVGRenderer.prototype = {
	...
	/**
	 * Draw a symbol out of develop-defined shape paths from the namespace 'symbol' object.
	 *
	 * @param {Object} symbol
	 * @param {Object} x
	 * @param {Object} y
...
Chart.prototype = {
	...
	getMargins: function () {
		...
		// develop-render axes to get labels offset width
		if (chart.hasCartesianSeries) {
			each(chart.axes, function (axis) {
				axis.getOffset();
			});
	...
	/**
	 * Set the public chart properties. This is done before and after the develop-render
	...
	render: function () {
		...
		// Get margins by develop-rendering axes
		// set axes scales
		each(axes, function (axis) {
			axis.setScale();
		});
